...
function insertPendingDecision(employeeId, background, optionA, optionB) {
  return getDb()
    ...
    .get(employeeId, background, optionA, optionB ?? null);
}
...
export {
  updateGoal as C,
  updateDecisionTag as S,
  insertCustomEmployee as _,
  findGoalTaskByTitle as a,
  insertReport as b,
  getDecisions as c,
  getEmployeeReports as d,
  getGoalTasks as f,
  insertActivity as g,
  getRecentReports as h,
  deletePendingDecision as i,
  getEmployeeActiveTasks as l,
  getRecentActivity as m,
  deleteCustomEmployee as n,
  getActiveGoals as o,
  getPendingDecisions as p,
  deleteGoal as r,
  getCustomEmployees as s,
  db_exports as t,
  getEmployeeActivity as u,
  insertDecision as v,
  updateGoalTaskStatus as w,
  searchDecisions as x,
  insertPendingDecision as y,
};
