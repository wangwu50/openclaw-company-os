...
function insertGoalTask(goalId, employeeId, title) {
  return getDb()
    .prepare("INSERT INTO goal_tasks (goal_id, employee_id, title) VALUES (?, ?, ?) RETURNING *")
    .get(goalId, employeeId, title);
}
...
function insertDecision(employeeId, summary, choice, context) {
  return getDb()
    ...
    .get(employeeId, summary, choice, context ?? null);
}
...
export {
  ...
  updateGoalTask as D,
  updateGoal as E,
  updateGoalTaskStatus as O,
  insertPendingDecision as S,
  updateDecisionTag as T,
  getRecentReports as _,
  findGoalTaskByTitle as a,
  insertCustomEmployee as b,
  getDecisionStats as c,
  getEmployeeActiveTasks as d,
  getEmployeeActivityForActiveGoals as f,
  getRecentActivity as g,
  getPendingDecisions as h,
  ...
  getReportsByDays as v,
  searchDecisions as w,
  insertDecision as x,
  insertActivity as y,
};
