...
function insertPendingDecision(employeeId, background, optionA, optionB, options) {
	return getDb().prepare("INSERT INTO pending_decisions (employee_id, background, option_a, option_b, options) VALUES (?, ?, ?, ?, ?) RETURNING *").get(employeeId, background, optionA, optionB ?? null, options ? JSON.stringify(options) : null);
}
...
function getDecisionStats() {
	const rows = getDb().prepare("SELECT result_tag, COUNT(*) as cnt FROM decisions GROUP BY result_tag").all();
...
function getReportsByDays(days) {
...
function getEmployeeActivityForActiveGoals(employeeId, limit = 5) {
...
//#endregion
export { insertReport as C, updateGoalTask as D, updateGoal as E, updateGoalTaskStatus as O, insertPendingDecision as S, updateDecisionTag as T, getRecentReports as _, findGoalTaskByTitle as a, insertCustomEmployee as b, getDecisionStats as c, getEmployeeActiveTasks as d, getEmployeeActivityForActiveGoals as f, getRecentActivity as g, getPendingDecisions as h, deletePendingDecision as i, getDecisions as l, getGoalTasks as m, deleteCustomEmployee as n, getActiveGoals as o, getEmployeeReports as p, deleteGoal as r, getCustomEmployees as s, db_exports as t, getDecisionsFiltered as u, getReportsByDays as v, searchDecisions as w, insertDecision as x, insertActivity as y };
